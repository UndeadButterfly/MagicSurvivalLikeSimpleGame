...
def reset_game():
    ...
    bullet_count_upgrades = bullet_speed_upgrades = split_upgrades = 0
    magnet_radius = 100.0
...
def add_kills_and_check_upgrade(amount):
    ...
    if kill_count >= kills_for_next_upgrade:
        ...
        upgrade_options = generate_upgrade_options(bullet_count_upgrades, split_upgrades, bullet_speed_upgrades)
...
def apply_single_upgrade(upgrade_id):
    ...
    global magnet_radius, magnet_radius_sq, bullet_count_upgrades, bullet_speed_upgrades, split_upgrades
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if is_game_over and event.key == pygame.K_r: reset_game()
    ...
    if is_game_over:
        ...
        screen.blit(overlay, (0, 0))
        screen.blit(config.title_font.render("GAME OVER", True, (255, 50, 50)), (config.GAME_WIDTH // 2 - 80, 220))
